...
- [x] Move TxnTypeSelector into TxnView instead of AppHome (`frontend/src/components/AppHome.jsx:237`)
...
- [x] automatically add more years in the year dropdown as we reach the future years
